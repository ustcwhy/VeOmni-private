...
export LR=1e-5
export BSZ=64
export OUTPUT_DIR="/data1/hyw/exp/kmz_qadata_exp/qwen2.5-7B-v1_v2-${LR}-bsz${BSZ}-steps5595"
export DATA_PATH="/data1/hyw/QAdata/train.veomni.all.merged_v1_v2.json"
# export DATA_PATH="/data1/hyw/QAdata/train.veomni.single_img.merged_v1_v2.json"

bash train.sh /home/hyw/VeOmni/tasks/omni/train_qwen2_5_vl.py /home/hyw/VeOmni/configs/multimodal/qwen2_5_vl/qwen2_5_vl_fsdp1.yaml \
    --data.train_path $DATA_PATH \
    --train.max_steps 5595 \
    --train.save_steps 1865 \
    --train.lr $LR \
