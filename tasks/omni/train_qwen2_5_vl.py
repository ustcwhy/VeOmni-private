...
def process_sample(
    ...
    **kwargs,
    ...
    if "image" in sample:
        # images = [Image.open(os.path.join(image_folder, sample["image"])).convert("RGB")]
    ...
    if image_embeds is not None:
        tokenized_example["image_embeds"] = image_embeds
...
def main():
    ...
    transform = partial(
        ...
        image_folder=args.train.image_folder,
    )
    ...
    for epoch in range(start_epoch, args.train.num_train_epochs):
        ...
        for _ in range(start_step, args.train.train_steps):
            ...
            if global_step == 1:
                ...
                if "input_ids" in micro_batches[0]:
                    print("input_ids:", processor.tokenizer.batch_decode(micro_batches[0]["input_ids"]))
